...
# Form implementation generated from reading ui file 'wavheader_editor_widget_rescale.ui'
#
...
class Ui_wavheader_editor_widget(object):
    def setupUi(self, wavheader_editor_widget):
        ...
        wavheader_editor_widget.resize(1028, 751)
        ...
        self.tableWidget_basisfields.setMinimumSize(QtCore.QSize(100, 10))
        ...
        self.gridLayout.addWidget(self.tableWidget_basisfields, 0, 0, 10, 1)
        ...
        self.tableWidget_3.setMinimumSize(QtCore.QSize(100, 40))
        ...
        self.gridLayout.addWidget(self.tableWidget_3, 7, 1, 3, 3)
        ...
        self.tableWidget_starttime.setMinimumSize(QtCore.QSize(100, 10))
        ...
        self.gridLayout.addWidget(self.tableWidget_starttime, 0, 1, 7, 1)
        ...
        self.gridLayout.addWidget(self.label_Filename_WAVHeader, 11, 0, 1, 2)
        ...
        self.pushButton_subtract.setMinimumSize(QtCore.QSize(10, 0))
        font = QtGui.QFont()
        font.setPointSize(10)
        self.pushButton_subtract.setFont(font)
        self.pushButton_subtract.setObjectName("pushButton_subtract")
        self.gridLayout.addWidget(self.pushButton_subtract, 2, 5, 1, 1)
        ...
        self.wavheader_dateTimeEdit_starttime.setMinimumSize(QtCore.QSize(10, 0))
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        self.gridLayout.addWidget(self.wavheader_dateTimeEdit_starttime, 1, 4, 1, 2)
        ...
        self.label_39.setMinimumSize(QtCore.QSize(10, 0))
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.gridLayout.addWidget(self.label_39, 0, 4, 1, 2)
        ...
        self.wavheader_timeEdit_subtr.setMinimumSize(QtCore.QSize(10, 0))
        font = QtGui.QFont()
        font.setPointSize(10)
        self.wavheader_timeEdit_subtr.setFont(font)
        self.wavheader_timeEdit_subtr.setObjectName("wavheader_timeEdit_subtr")
        self.gridLayout.addWidget(self.wavheader_timeEdit_subtr, 3, 4, 1, 2)
        ...
        self.wavheader_dateTimeEdit_result.setMinimumSize(QtCore.QSize(0, 10))
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        self.gridLayout.addWidget(self.wavheader_dateTimeEdit_result, 4, 4, 1, 2)
        ...
        self.pushButton_InsertHeader.setMinimumSize(QtCore.QSize(10, 10))
        font = QtGui.QFont()
        font.setPointSize(10)
        self.pushButton_InsertHeader.setFont(font)
        self.pushButton_InsertHeader.setObjectName("pushButton_InsertHeader")
        self.gridLayout.addWidget(self.pushButton_InsertHeader, 2, 2, 1, 2)
    ...
    def retranslateUi(self, wavheader_editor_widget):
        ...
        self.pushButton_InsertHeader.setToolTip(_translate("wavheader_editor_widget", "insert wav-header with current metadata into dat file"))
        self.pushButton_InsertHeader.setText(_translate("wavheader_editor_widget", "Insert Header"))
