...
def stream_to_fl2k_file(input_file, target_sampling_rate, targetfile_path, buffer_size=4096, fl2k_file_path="fl2k_file"):
    """
    ...
    if mode == "ADALM":
        ...
        "[re][sine_cos]amultiply[mod_re];"
        "[im][sine_sin1]amultiply[mod_im];"
        "[mod_im]volume=volume=2000[part_im];"
        "[mod_re]volume=volume=2000[part_re];"
        "[part_re][part_im]amix=inputs=2:duration=shortest[out]",
        ...
        try:
            ...
            with open(input_file, "rb") as f:
                ...
                while chunk := f.read(buffer_size):
                    ...
                    print("write chunk to ffmpeg stdin")
...
stream_to_fl2k_file(sourcefile_path, 10000000, targetfile_path, 4096*256*16*8, fl2k_file_path)
